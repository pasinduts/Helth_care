...
public class PatientsAPI extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)	throws ServletException, IOException {
		...
		String output = patientcontroller.readPatient();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		patient.setBlood_group(request.getParameter("bg"));
		patient.setPcontact(request.getParameter("contact"));

		String output = patientcontroller.AddPatient(patient);
